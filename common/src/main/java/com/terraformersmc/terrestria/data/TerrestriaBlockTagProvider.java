...
//		valueLookupBuilder(BlockTags.BUTTONS).add(stoneBlock.button);
//		valueLookupBuilder(BlockTags.PRESSURE_PLATES).add(stoneBlock.pressurePlate);
	}
...
//		valueLookupBuilder(BlockTags.FENCE_GATES).add(woodBlock.fenceGate);
		...
		valueLookupBuilder(BlockTags.SLABS).add(woodBlock.slab);
		valueLookupBuilder(BlockTags.STAIRS).add(woodBlock.stairs);
...
//		valueLookupBuilder(BlockTags.WOODEN_PRESSURE_PLATES).add(woodBlock.pressurePlate);
		...
		valueLookupBuilder(BlockTags.HOE_MINEABLE).add(woodBlock.leaves);
